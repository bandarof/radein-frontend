...
const logos: Logo[] = [
  ...
  { name: "web3.js", slug: "web3dotjs", color: "143CFB", desc: "JavaScript libraries for interacting with Ethereum and EVM-compatible blockchains." },
    { name: "ArcGIS", slug: "arcgis", color: "007AC2", desc: "Geospatial mapping and GIS platform for mapping, spatial analysis, and geodata management." },
    { name: "SketchUp", slug: "sketchup", color: "EA3323", desc: "3D modeling software for architecture, construction, and design visualization." },
