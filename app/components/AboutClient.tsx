      ...
      <div className="mt-6 grid grid-cols-1 gap-8 md:grid-cols-3">
        <div className="md:col-span-2 pop-in delay-300">
          ...
          <div className="pop-in delay-400">
            <LinkedInProfile profileUrl="https://www.linkedin.com/in/bandarof/" initialSummary={defaultText} onPosts={(p:any)=>setPosts(p)} />
          </div>

          <div className="mt-6 pop-in delay-450">
            <h3 className="text-xl font-semibold mb-4">LinkedIn Feed</h3>
            <LinkedInEmbed profileUrl="https://www.linkedin.com/in/bandarof/" posts={posts} />
          </div>
        </div>
