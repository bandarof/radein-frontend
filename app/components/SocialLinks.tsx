    ...
    <div className={"flex items-center gap-3 " + className}>
      {links.map((l) => (
        <a
          ...
          aria-label={l.name}
          title={l.name}
          className="inline-flex items-center justify-center w-9 h-9 rounded-md bg-gray-800/40 hover:bg-gray-700/60 transition shadow-sm hover:ring-4 hover:ring-cyan-400/60 hover:shadow-[0_0_12px_rgba(6,182,212,0.45)] text-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/40"
        >
